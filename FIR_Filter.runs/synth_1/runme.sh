...
HD_PWD='D:/GitHub/github/LMS-FIR-Filter/FIR_Filter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_filter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_filter.tcl
