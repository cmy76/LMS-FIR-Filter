...
HD_PWD='D:/GitHub/github/LMS-FIR-Filter/FIR_Filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_filter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_filter.tcl -notrace
